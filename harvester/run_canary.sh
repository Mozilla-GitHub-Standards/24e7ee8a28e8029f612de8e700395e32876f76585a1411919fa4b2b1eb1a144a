...
curl -v -X PUT "http://taskcluster/index/v1/task/project.nss-nspr.canary-harvester-test.${timestamp}" -H 'Content-Type: application/json' -d "{\"taskId\":\"${TASK_ID}\", \"rank\":10, \"data\":{}, \"expires\":\"2019-02-05T17:12:45.495Z\"}"
